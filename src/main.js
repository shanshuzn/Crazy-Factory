    ...
    const OVERDRIVE_UNLOCK_LIFETIME_GEARS = 500;
    const OVERDRIVE_COST_GEARS = 180;
    const OVERDRIVE_DURATION_MS = 12_000;
    const OVERDRIVE_COOLDOWN_MS = 30_000;
    const OVERDRIVE_GPS_MULT = 2;
    const DEFAULT_FINANCE_ASSETS = Object.freeze({ bond: 0.34, equity: 0.33, derivative: 0.33 });
    ...
    const state = {
      ...
      financeLeaderboard: [],
      financeAssets: { ...DEFAULT_FINANCE_ASSETS },
      financeLineage: 0,
