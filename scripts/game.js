    ...
    // 版本号（单一来源：scripts/version.js 提供 window.CF_VERSION / window.CF_CHANGELOG）
    const APP_VERSION = (typeof window !== 'undefined' && window.CF_VERSION) || 'v2.15.0';
    const CHANGELOG = (typeof window !== 'undefined' && window.CF_CHANGELOG) || [];
